...
local pi = math.pi
TDT.dungeonTotalCount[dungeonIndex] = {normal=150,teeming=180,teemingEnabled=true}
TDT.dungeonBosses[dungeonIndex] = {--Maw of Souls
	[1] = {
		[1] = {
...
TDT.dungeonEnemies[dungeonIndex] = { --Maw of Souls
	[1] = {
