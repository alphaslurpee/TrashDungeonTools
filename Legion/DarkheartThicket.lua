...
local pi = math.pi
TDT.dungeonTotalCount[dungeonIndex] = {normal=280,teeming=336,teemingEnabled=true}
TDT.dungeonBosses[dungeonIndex] = {--Darkheart Thicket
	[1] = {
		[1] = {
...
TDT.dungeonEnemies[dungeonIndex] = { --Darkheart Thicket
	[1] = {
