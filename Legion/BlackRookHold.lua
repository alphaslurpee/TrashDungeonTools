...
local pi = math.pi
TDT.dungeonTotalCount[dungeonIndex] = { normal=300, teeming=360, teemingEnabled=true}
TDT.dungeonBosses[dungeonIndex] = {--Black Rook Hold
	[1] = {
		[1] = {
...
TDT.dungeonEnemies[dungeonIndex] = { --Black Rook Hold
	[1] = {
