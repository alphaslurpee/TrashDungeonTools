...
TDT.dungeonTotalCount[dungeonIndex] = {normal=305,teeming=335,teemingEnabled=true}
TDT.dungeonBosses[dungeonIndex] = { --Cathedral of Eternal Night
	[2] = {
		[1] = {
			["name"] = "Agronox",
			["encounterID"] = 1905,
...
TDT.dungeonEnemies[dungeonIndex] = { --Cathedral of Eternal Night
	[1] = {
